...
// This contains the MapView in XML and needs to be called after the access token is configured.
        ...
        mapView = findViewById(R.id.mapActivityView);
...
// Each point range gets a different fill color.
        int[][] layers = new int[][] {
                new int[] {50, ContextCompat.getColor(this, R.color.red)},
                new int[] {10, ContextCompat.getColor(this, R.color.mapbox_plugins_green)},
